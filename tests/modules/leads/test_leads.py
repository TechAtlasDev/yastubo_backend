...
@pytest.mark.asyncio
async def test_create_lead_success(client: AsyncClient, default_company):
    payload = {
        "first_name": "Test",
        "last_name": "Lead",
...
@pytest.mark.asyncio
async def test_duplicate_lead_updates_existing(client: AsyncClient, default_company):
    # First creation
