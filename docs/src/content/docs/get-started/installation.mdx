...
> [FLOW: El desarrollador inicia el proceso con Git. El script de Setup Maestro interactúa con uv para el entorno y con Docker para la base de datos. Se ejecutan las migraciones de Alembic y finalmente se valida la preparación mediante la CLI.]
