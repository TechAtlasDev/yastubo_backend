...
> [FLOW: Autenticación de usuario -> Creación de Cliente -> Emisión de Póliza en estado DRAFT vinculada a un Plan -> Simulación de Pago -> Transición de Póliza a ACTIVE -> Generación de Certificado PDF.]
