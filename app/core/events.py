...
async def dispatch_event(event_type: str, data: Dict[str, Any], metadata: Optional[Dict[str, Any]] = None) -> bool:
    """
...
def dispatch_event_background(event_type: str, data: Dict[str, Any], metadata: Optional[Dict[str, Any]] = None):
