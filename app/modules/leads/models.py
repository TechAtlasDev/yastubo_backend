...
class Lead(BaseModel):
    ...
    phone_e164: Mapped[str] = mapped_column(String(50), unique=True, index=True, nullable=False)
    ...
    country_of_residence: Mapped[Optional[str]] = mapped_column(String(2), nullable=True)
    ...
    funnel_stage: Mapped[FunnelStage] = mapped_column(String(50), default=FunnelStage.AWARENESS)
    lead_score: Mapped[int] = mapped_column(Integer, default=0)
    intent_level: Mapped[Optional[str]] = mapped_column(String(50), nullable=True) # LOW, MEDIUM, HIGH

    # Conversation tracking
    first_contact_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    last_conversation_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    last_conversation_channel: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    conversation_status: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    ...
    chatwoot_conversation_id_last: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    ...
    abandoned_checkout_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    ...
    followup_whatsapp_sent_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    ...
    backend_customer_id: Mapped[Optional[uuid.UUID]] = mapped_column(GUID(), nullable=True) # Link to Client once converted
