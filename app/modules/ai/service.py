...
class AIService:
    ...
    async def get_relevant_documents(self, db: AsyncSession, workspace_id: uuid.UUID, query: str, limit: int = 5) -> List[KnowledgeDocument]:
    ...
    async def chat_with_context(self, db: AsyncSession, workspace_id: uuid.UUID, session_id: str, message: str) -> str:
