...
from sqlalchemy import String, ForeignKey, Text, JSON, Column
...
class KnowledgeDocument(BaseModel):
    ...
    workspace_id: Mapped[uuid.UUID] = mapped_column(GUID(), ForeignKey("workspaces.id", ondelete="CASCADE"), nullable=False, index=True)
...
class ChatMessage(BaseModel):
    ...
    conversation_id: Mapped[uuid.UUID] = mapped_column(GUID(), ForeignKey("chat_conversations.id", ondelete="CASCADE"), nullable=False)
