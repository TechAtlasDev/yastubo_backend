    ...
    def decorator(func: Callable):
        ...
        async def wrapper(*args, **kwargs):
            ...
            if not user_id:
                ...
                user_id = (
                    all_args.get("created_by") or 
                    all_args.get("updated_by") or 
                    all_args.get("user_id") or 
                    all_args.get("changed_by") or 
                    all_args.get("registered_by") or
                    all_args.get("issued_by") or
                    all_args.get("cancelled_by") or
                    all_args.get("registered_by")
                )
            ...
            if db:
                ...
                if not entity_id and isinstance(result, (str, bytes, int, float, uuid.UUID)):
