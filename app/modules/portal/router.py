...
async def cancel_portal_policy(
    ...
    return await portal_service.cancel_policy_by_client(db, policy_id, client.id, reason)
...
async def add_portal_payment_method(
    ...
    return await portal_service.add_payment_method(db, stripe, current_user.id, stripe_payment_method_id)
