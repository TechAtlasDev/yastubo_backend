...
VALID_TRANSITIONS = {
    ...
    PolicyStatus.PENDING_PAYMENT: [PolicyStatus.ACTIVE, PolicyStatus.CANCELLED, PolicyStatus.IN_ARREARS],
    PolicyStatus.ACTIVE:          [PolicyStatus.IN_ARREARS, PolicyStatus.CANCELLED,
