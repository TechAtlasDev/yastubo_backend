...
class Subscription(BaseModel):
    ...
    subscription_created_at: Mapped[datetime] = mapped_column(DateTime, server_default=func.now())
    subscription_activated_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
