...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("whatsapp_opt_in_status", sa.Boolean(), nullable=False, server_default="false"),
        ...
        sa.Column("ai_handled_flag", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column("human_handoff_flag", sa.Boolean(), nullable=False, server_default="false"),
        ...
        sa.Column("form_completed", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column("checkout_started", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column("checkout_started_at", sa.DateTime(), nullable=True),
        sa.Column("checkout_completed", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column("abandoned_checkout_flag", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column("abandoned_checkout_at", sa.DateTime(), nullable=True),
        sa.Column("purchase_completed", sa.Boolean(), nullable=False, server_default="false"),
        # Follow-up
        sa.Column("followup_whatsapp_sent", sa.Boolean(), nullable=False, server_default="false"),
        ...
        sa.Column("converted_to_contact_flag", sa.Boolean(), nullable=False, server_default="false"),
