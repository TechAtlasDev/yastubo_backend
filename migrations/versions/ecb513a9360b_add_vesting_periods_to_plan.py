...
def upgrade() -> None:
    ...
    op.add_column(
        "plans",
        sa.Column(
            "vesting_accidental_days", sa.Integer(), nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "plans",
        sa.Column(
            "vesting_natural_days", sa.Integer(), nullable=False, server_default="180"
        ),
    )
    op.add_column(
        "plans",
        sa.Column(
            "vesting_suicide_days", sa.Integer(), nullable=False, server_default="365"
        ),
    )
